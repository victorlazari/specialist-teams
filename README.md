...
A comprehensive knowledge base of 51 specialist domains for AI agents and engineering teams. Each specialist includes **7 detailed documentation files** covering core concepts, advanced patterns, CLI references, troubleshooting, security audits, configuration schemas, and deep-dive architecture guides.

**Total: 357 files | 935,000+ words | 51 specialist domains**
...
| 48 | **OpenTelemetry Collector** | specialist, advanced, cli-reference, troubleshooting, security-audit, config-schemas, deep-dive |
| 49 | **Docker Super Specialist** | specialist, advanced, cli-reference, troubleshooting, security-audit, config-schemas, deep-dive |
| 50 | **Slack Master Specialist** | specialist, advanced, cli-reference, troubleshooting, security-audit, config-schemas, deep-dive |
| 51 | **Passkeys Super Specialist** | specialist, advanced, cli-reference, troubleshooting, security-audit, config-schemas, deep-dive |
